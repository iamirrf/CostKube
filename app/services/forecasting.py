...
class ForecastService:
    ...
    def forecast_costs(
        ...
        total_forecast_monthly = sum(forecast_costs[:30]) * 24  # Convert daily to monthly
        ...
        return {
            ...
            'current_monthly_cost': float(mean_cost * 730),  # Approximate monthly from hourly
            'trend': trend,
    ...
    def _get_budget_recommendation(self, days: int, trend: str) -> str:
        ...
        if days > 180:
            ...
            return f"Budget runway is {days} days. Consider planning for the next quarter."
        elif days > 30:
    ...
    def seasonal_analysis(
        ...
        return {
            ...
            'weekend_avg': float(np.mean([day_averages['Saturday'], day_averages['Sunday']])),
